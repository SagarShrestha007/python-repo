## This repository contains solutions to a set of programming assignments that cover basic Python concepts, including loops, conditionals, functions, and user input.
